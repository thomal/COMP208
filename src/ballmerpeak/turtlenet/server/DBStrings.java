...
class DBStrings {
    ...
    public static final String categoriesCanSeePDATA = "SELECT catID FROM tCategory WHERE canSeePDATA = 1;";
    ...
    public static final String removeFromCategory    = "DELETE FROM tCategoryMembers WHERE catId = '__catID__' AND userKey = '__key__';";
