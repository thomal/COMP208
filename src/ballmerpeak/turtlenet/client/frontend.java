...
public class frontend implements EntryPoint {
    private static final String SERVER_ERROR  = "An error occurred while " +
                 "attempting to contact the server. Please check Turtlenet is running.";
    private static final String RSERVER_ERROR = "An error occurred while " +
                 "attempting to contact the remote server.";
...
//PAGE SETUP----------------------------------------------------------------
        ...
        class MyHandler implements ClickHandler, KeyUpHandler {
            ...
            private void sendNameToServer() {
                ...
                turtlenet.test(textToServer, new AsyncCallback<String>() {
        ...
        //have local server connect to remote server
